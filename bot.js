...
bot.login('Nzg3OTI2MDAxNjQwMjc2MDEw.X9cDRQ.w5BxzlosbECfnFpDWJXPPEYXf1k');
...
bot.on('message', message => {
    ...
    if(message.content === prefix + "créateur"){
        ...
        message.channel.sendMessage("Le créateur est <@780433369196003368>!!!")
    ...
    if (message.content === prefix + "help"){
        ...
        .setFooter("signaler un bug? faite `>_`créateur")
